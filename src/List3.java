...
public class List3<T> extends ListSecondary<T> {
    ...
    private void createNewRep() {
        ...
        /*
         * For the initialized nodes, ensure that the node following preStart is
         * postFinish and the node previous to postFinish is preStart. lastLeft
         * is also the same as the preStart node when initialized.
         */
        ...
        /*
         * Initialize the left and right lengths to be 0.
         */
        this.leftLength = 0;
        this.rightLength = 0;
    ...
    public List3() {
        /*
         * The no-argument constructor is initialized by createNewRep.
         */
        this.createNewRep();
    ...
    public final void clear() {
        /*
         * Clearing the list will create an initialized list that createNewRep
         * creates.
         */
        this.createNewRep();
    ...
    public final void addRightFront(T x) {
        ...
        /*
         * oldNode is the node that used to be the rightFront before this method
         * call.
         */
        Node oldNode = this.lastLeft.next;

        /*
         * Insert newNode to be the front of the right while transferring the
         * data into that node as well.
         */
        ...
        /*
         * Update the length of the right.
         */
        this.rightLength++;
    ...
    public final T removeRightFront() {
        ...
        /*
         * The removed node will be the front of the right, also known as the
         * lastLeft.next.
         */
        Node removedNode = this.lastLeft.next;

        /*
         * Update the lastLeft's next value to be the value after the now
         * removed front right node and ensure the previous of the new front
         * right is the last left.
         */
    ...
    public final void advance() {
        ...
        /*
         * Update lastLeft to be the next value in the list.
         */
        Node p = this.lastLeft;
        this.lastLeft = p.next;

        /*
         * Update the length of both the left and right.
         */
        this.leftLength++;
        this.rightLength--;
    ...
    public final void moveToStart() {
        /*
         * Moves the position in the list to the first node.
         */
        this.lastLeft = this.preStart;
    ...
    public final void moveToFinish() {
        /*
         * Moves the position in the list to the last value.
         */
    ...
    public final void retreat() {
        ...
        /*
         * Update lastLeft to be the previous value of the current lastLeft.
         */
        Node p = this.lastLeft;
